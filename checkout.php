        ...
        <div class="col-lg-6 px-4 pb-4" id="order">
            ...
            <form action="" method="post" id="placeOrder">
                ...
                <div class="form-group">
                    <input type="text" name="name" class="form-control" placeholder="Entername" require>
                    <input type="email" name="email" class="form-control" placeholder="Enteremail" require>
                    <input type="tel" name="phone" class="form-control" placeholder="EnterPhonenumber" require>
                    
                </div>
                <div class="form-group">
                    <textarea name="address" class="form-control" rows="3" cols="10" placeholder="Enter Delivery Address Here.."></textarea>
                </div>
                <h6 class="text-center lead">Select Payment </h6>
                <div class="form-group">
                    <select name="pmode" class="form-control" id="">
                        <option value="" selected disabled>-Select Payment-</option>
                        <option value="cod">Cash On Delivery</option>
                        <option value="true">TrueMoneyWallet</option>
